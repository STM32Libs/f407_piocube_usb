...
{
  //Function is chip dependent
  //Error handling, should not have been called as not expected to link with library
  //replaced with HAL_PCD_MspInit_FS_no_cb from usb_app.cpp
  while(1){
  }
}
